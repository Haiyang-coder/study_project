...
CPoint CWatchDialog::UserPoint2RemoteScreen(CPoint& point)
{
	//进行鼠标坐标的转换
	CRect clientRect;
	...
	int widthRemote = 1920;
	int heighRemote = 1080;
	int x = point.x * width / widthRemote;
	int y = point.y * height / heighRemote;
	return CPoint(x, y);
}
